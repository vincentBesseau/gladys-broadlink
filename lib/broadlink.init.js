...
module.exports = function init() {
    ...
    .then((broadlinkDevices) => {
        ...
        // reset all instances 
        shared.instance.rm2Instances = {};
        shared.instance.mp1Instances = {};
        ...
        broadlinkDevices.forEach(broadlinkDevice => {
            ...
            if(broadlinkDevice.protocol === 'RM2') {
                shared.instance.rm2Instances[broadlinkDevice.id] = new Broadlink.BroadlinkDeviceRM2(options);
            }

            if(broadlinkDevice.protocol === 'MP1') {
                shared.instance.mp1Instances[broadlinkDevice.id] = new Broadlink.BroadlinkDeviceMP1(options);
            }
        });
    })
};
