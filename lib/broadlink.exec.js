...
module.exports = function(params) {
	...
	if(!shared.instances[params.deviceType.device]) return reject(`No broadlink with deviceId ${params.deviceType.device}`);

	// call the broadlink function
	var broadlink = shared.instances[params.deviceType.device];
